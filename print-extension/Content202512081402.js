...
function showPrintPreview(printData, transferNos) {
  try {
    ...
    //         window.removeEventListener('message', messageHandler);
    //       } else if (event.data.type === 'PRINTER_LIST_ERROR') {
    ...
    //         const printerCount = LODOP.GET_PRINTER_COUNT();
    //         const printers = [];
    //         let defaultPrinterIndex = 0; // 默认使用索引0作为默认打印机
    ...
    //             index: i,
    //             name: printerName,
    //             isDefault: i === defaultPrinterIndex // 索引0为默认打印机
    //           });
    //         }
...
//     const dialogWrapper = document.createElement('div');
//     dialogWrapper.className = 'el-dialog__wrapper';
//     dialogWrapper.style.cssText = 'z-index: 2016;';
...
//     // 打印机选择区域
//     const printerSelect = document.createElement('div');
//     printerSelect.innerHTML = '<br><span>选择打印机:</span>';
    
//     const selectContainer = document.createElement('div');
//     selectContainer.className = 'el-select el-select--small';
//     selectContainer.style.cssText = 'width: 300px;';
    
//     const selectInput = document.createElement('div');
//     selectInput.className = 'el-input el-input--small el-input--suffix';
//     selectInput.innerHTML = `<input type="text" readonly="readonly" autocomplete="off" placeholder="选择打印机" class="el-input__inner">
//       <span class="el-input__suffix">
//         <span class="el-input__suffix-inner">
//           <i class="el-select__caret el-input__icon el-icon-arrow-up"></i>
//         </span>
...
//     const dropdown = document.createElement('div');
//     dropdown.className = 'el-select-dropdown el-popper';
//     dropdown.style.cssText = 'display: none; min-width: 300px;';
...
//           <li class="el-select-dropdown__item"><span>导出为WPS PDF</span></li>
//           <li class="el-select-dropdown__item"><span>OneNote (Desktop)</span></li>
//           <li class="el-select-dropdown__item"><span>Microsoft XPS Document Writer</span></li>
//           <li class="el-select-dropdown__item"><span>Microsoft Print to PDF</span></li>
//           <li class="el-select-dropdown__item"><span>Fax</span></li>
//           <li class="el-select-dropdown__item selected"><span>EPSON LQ-630K ESC/P2</span></li>
//         </ul>
//       </div>
//     `;
...
//       try {
//         // 获取选中的打印机
//         const selectedPrinter = dropdownContent.querySelector('.el-select-dropdown__item.selected');
//         const printerName = selectedPrinter ? selectedPrinter.textContent.trim() : 'EPSON LQ-630K ESC/P2';

//         // 直接打印预览内容
//         await printDirect(printPreviewDiv.innerHTML, printerName);

//         // 显示成功消息
//         showMessage('打印任务已发送到打印机', 'success');
//         // 打印成功后自动关闭预览对话框
//         closeDialog();
//       } catch (error) {
//         console.error('打印失败:', error);
      ...
      <head>
        <script>
          try {
            ...
            LODOP.SET_PRINT_STYLEA(0, "MarginBottom", "10mm"); // 调整下边距
            // 直接发送到打印机，不显示预览
            LODOP.PRINT();
