...
##        part_name_entry.pack(side=tk.LEFT, padx=5)  
    ...
    def setup_data_table(self, parent):
        ...
        tk.Button(button_frame, text="调拨单打印预览", command=self.print_preview).pack(side=tk.LEFT, padx=(0, 20))
...
# ... existing code ...
    ...
    def generate_storage_locations_set(self, max_level,maxnum):
        """
        使用集合生成所有可能的库位（优化版本）
        """
        locations_set = set()
...
# ... existing code ...
    ...
    def print_preview(self):
        """调拨单打印预览"""
        # 这里可以添加打印预览的实现
        messagebox.showinfo("提示", "调拨单打印预览功能")
